...
export class SkillService {
  ...
  constructor() {
    ...
    this.skills.push(new Skill("WordPress", SkillType.FRONTEND));
    this.skills.push(new Skill("Elementor", SkillType.FRONTEND));
    ...
    this.skills.push(new Skill("Decision Making Thinking", SkillType.SOFT));
